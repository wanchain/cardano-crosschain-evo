...
main = do
  let v2dir = "generated-plutus-scripts/v2"
      ...
      oldTreasuryCheckTokenSymbolBytes = [0x7a,0x1f,0x5c,0x38,0xbf,0x9f,0xa9,0xce,0x47,0x1c,0x3b,0x94,0xe7,0x91,0x27,0xa6,0xdd,0x6e,0xc8,0xaf,0xee,0x5c,0x1d,0x80,0xcc,0x29,0xfb,0x1a]
      oldMintCheckTokenSymbolBytes     = [0x4e,0xfa,0xed,0x8e,0x4c,0xe8,0xc4,0xcb,0x47,0xd8,0x9e,0xa8,0x0a,0xdc,0x16,0xb2,0x9f,0x10,0xe6,0xe6,0x33,0x25,0xd1,0xf9,0x7e,0x4b,0x64,0x43]
...
----------------------------------------------------------      
  ...
  _ <- writeRedeemer (datadir </>"./nftTreasuryCheckProof.json") (PlutusTx.toBuiltinData  nftTreasuryCheckProof)
  
  _ <- writeRedeemer (datadir </>"./nftMintCheckProof.json") (PlutusTx.toBuiltinData  nftMintCheckProof)
